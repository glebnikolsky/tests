...
{
	HTREEITEM hRoot = m_wndFileView.InsertItem(_T("Ôàéëû FakeApp"), 0, 0);
	m_wndFileView.SetItemState(hRoot, TVIS_BOLD, TVIS_BOLD);

	HTREEITEM hSrc = m_wndFileView.InsertItem(_T("Èñõîäíûå ôàéëû FakeApp"), 0, 0, hRoot);
	...
	HTREEITEM hInc = m_wndFileView.InsertItem(_T("Ôàéëû çàãîëîâêà FakeApp"), 0, 0, hRoot);
	...
	HTREEITEM hRes = m_wndFileView.InsertItem(_T("Ôàéëû ðåñóðñîâ FakeApp"), 0, 0, hRoot);
