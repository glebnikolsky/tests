...
/////////////////////////////////////////////////////////////////////////////
// îáðàáîò÷èêè ñîîáùåíèé CClassView
...
int CClassView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	{
		TRACE0("Íå óäàëîñü ñîçäàòü ïðåäñòàâëåíèå êëàññîâ\n");
		return -1;      // íå óäàëîñü ñîçäàòü
	}

	// Çàãðóçêà èçîáðàæåíèé:
	m_wndToolBar.Create(this, AFX_DEFAULT_TOOLBAR_STYLE, IDR_SORT);
	m_wndToolBar.LoadToolBar(IDR_SORT, 0, 0, TRUE /* Çàáëîêèðîâàí */);
...
{
	HTREEITEM hRoot = m_wndClassView.InsertItem(_T("Êëàññû FakeApp"), 0, 0);
...
{
	AfxMessageBox(_T("Äîáàâèòü ôóíêöèþ-÷ëåí..."));
}
...
{
	AfxMessageBox(_T("Ñîçäàòü ïàïêó..."));
}
...
void CClassView::OnChangeVisualStyle()
{
	...
	{
		TRACE(_T("Íå óäàåòñÿ çàãðóçèòü òî÷å÷íûé ðèñóíîê: %x\n"), uiBmpId);
		ASSERT(FALSE);
		return;
	}
	...
	m_wndToolBar.LoadBitmap(theApp.m_bHiColorIcons ? IDB_SORT_24 : IDR_SORT, 0, 0, TRUE /* Çàáëîêèðîâàí */);
}
