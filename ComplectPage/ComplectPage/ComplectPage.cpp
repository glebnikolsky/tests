...
// ComplectPage.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CComplectPageApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CComplectPageApp

CComplectPageApp::CComplectPageApp()
{
...
// Единственный объект CComplectPageApp

CComplectPageApp theApp;


// инициализация CComplectPageApp

BOOL CComplectPageApp::InitInstance()
{
