...
//	COverallProgressDlg progress;					///< прогресс диалог
	bool                bProgressExists = false;	///< для блокировки повторного создания диалога прогресса

	CString headers[] = {
		_T( "№" ),
		_T( "Имя базы данных" ),
		_T( "Представительство" ),
		_T( "Схема" ),
		_T( "Авторизация" ),
		_T( "Бланков №1" ),
		_T( "Бланков №2" ),
		_T( "Бланков регистрации" ),
		_T( "Тестов" ),
		_T( "Дополнительно" ),
		_T( "Тип БД" ),
		_T( "Версия" ),
	...
	short align[] = {UG_ALIGNLEFT, UG_ALIGNLEFT, UG_ALIGNLEFT, UG_ALIGNLEFT, UG_ALIGNCENTER, UG_ALIGNRIGHT, UG_ALIGNRIGHT, UG_ALIGNRIGHT, UG_ALIGNRIGHT, UG_ALIGNLEFT, UG_ALIGNLEFT, UG_ALIGNLEFT, UG_ALIGNLEFT, UG_ALIGNCENTER};


	CString gridName = _T( "CreateDatabaseGrid" );

	std::vector<int> sortOrder( sizeof( headers ) / sizeof( CString ), UG_SORT_ASCENDING );

	COLORREF backgroundColor[2] = {RGB( 255,255,255 ), RGB( 220,255,220 )};
	COLORREF errcolor = {RGB( 255,0,0 )};
}
