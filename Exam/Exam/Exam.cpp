...
// Exam.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CExamApp, CWinAppEx)
...
// Единственный объект CExamApp

CExamApp theApp;


// инициализация CExamApp
...
// обработчики сообщений CExamApp
...
// CExamApp настройка методов загрузки и сохранения

void CExamApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CExamApp::LoadCustomState()
{
}

void CExamApp::SaveCustomState()
{
}
