...
// ShP.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CShPApp, CWinApp)
...
// Единственный объект CShPApp

CShPApp theApp;


// инициализация CShPApp

BOOL CShPApp::InitInstance()
{
