...
// OfficeVersionDemo.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(COfficeVersionDemoApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание COfficeVersionDemoApp

COfficeVersionDemoApp::COfficeVersionDemoApp()
{
...
// Единственный объект COfficeVersionDemoApp

COfficeVersionDemoApp theApp;


// инициализация COfficeVersionDemoApp

BOOL COfficeVersionDemoApp::InitInstance()
{
