...
CEventLogRecord::CEventLogRecord(_In_ const CEventLogRecord& record) : m_dwRecordNumber(record.m_dwRecordNumber),
...
#pragma warning(suppress: 26495)
CEventLogRecord::CEventLogRecord(_Inout_ CEventLogRecord&& record) noexcept : m_dwRecordNumber(record.m_dwRecordNumber),
                                                                              m_dwTimeGenerated(record.m_dwTimeGenerated),
                                                                              m_dwTimeWritten(record.m_dwTimeWritten),
                                                                              m_dwEventID(record.m_dwEventID),
                                                                              m_wEventType(record.m_wEventType),
                                                                              m_wEventCategory(record.m_wEventCategory),
                                                                              m_UserSID(std::move(record.m_UserSID)),
                                                                              m_Strings(std::move(record.m_Strings)),
                                                                              m_Data(std::move(record.m_Data)),
                                                                              m_sSourceName(std::move(record.m_sSourceName)),
                                                                              m_sComputerName(std::move(record.m_sComputerName))
{
}
...
CEventLogRecord& CEventLogRecord::operator=(_Inout_ CEventLogRecord&& record) noexcept
{
  m_dwRecordNumber = record.m_dwRecordNumber;
  m_dwTimeGenerated = record.m_dwTimeGenerated;
  m_dwTimeWritten = record.m_dwTimeWritten;
