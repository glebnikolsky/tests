...
//Methods
  ...
  _Return_type_success_(return != 0) BOOL Attach(_In_opt_ HANDLE hEventSource) noexcept;
  ...
  static _Return_type_success_(return != 0) BOOL SetStringArrayIntoRegistry(_In_ ATL::CRegKey& key, _In_opt_z_ LPCTSTR pszEntry, _In_ const CNTServiceStringArray& array, _Inout_opt_ DWORD* pLastError = nullptr) noexcept;
