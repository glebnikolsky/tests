...
#pragma warning(suppress: 26472)
  bSuccess = testService.WriteProfileBinary(_T("General"), _T("BinaryValue"), bySetData.data(), static_cast<UINT>(bySetData.size()));

  array.clear();
  bSuccess = testService.GetProfileStringArray(_T("General"), _T("StringArrayValue"), array);

  std::vector<BYTE> getData;
  bSuccess = testService.GetProfileBinary(_T("General"), _T("BinaryValue"), getData);
  ...
  if (bSuccess2)
  {
    ...
    bSuccess2 = manager.QueryLockStatus(lockStatus);
    bSuccess2 = manager.Lock();
    bSuccess2 = manager.Unlock();
    bSuccess2 = manager.QueryLockStatus(lockStatus);
    bSuccess2 = manager.EnumServices(SERVICE_WIN32, SERVICE_STATE_ALL, nullptr, EnumServices);
    bSuccess2 = manager.EnumServices(SERVICE_WIN32, SERVICE_STATE_ALL, nullptr, nullptr, EnumServices2);
    ...
    if (bSuccess2)
    {
      ...
      */
      ...
      UNREFERENCED_PARAMETER(bSuccess2);
      bSuccess2 = service.ChangeFailureActions(failureActions);
      ...
      UNREFERENCED_PARAMETER(bSuccess2);
      bSuccess2 = service.ChangeTrigger(triggerInfo);

      SERVICE_CONTROL_STATUS_REASON_PARAMS scsrp = { 0 };
