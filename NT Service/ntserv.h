...
//Persistance support
  ...
  virtual _Return_type_success_(return!=0) BOOL WriteProfileStringArray(_In_opt_z_ LPCTSTR pszSection, _In_opt_z_ LPCTSTR pszEntry, _In_ const CNTServiceStringArray& array) noexcept;
  ...
  static _Return_type_success_(return!=0) BOOL WriteServiceProfileStringArray(_In_opt_z_ LPCTSTR pszService, _In_opt_z_ LPCTSTR pszSection, _In_opt_z_ LPCTSTR pszEntry, _In_ const CNTServiceStringArray& array, _In_ BOOL bFlush, _Inout_opt_ DWORD* pLastError = nullptr) noexcept;
  ...
  BOOL _Return_type_success_(return != 0) GetProfileWriteFlush() const noexcept { return m_bProfileWriteFlush; };
...
//Other Methods
  ...
  virtual void ShowHelp() noexcept;

  //Called to display a message for the service to the end-user
  virtual void DisplayMessage(_In_ const CNTServiceString& sMessage) noexcept;
...
//Methods
  ...
  virtual UINT MapResourceID(_In_ UINT nID) noexcept;
  virtual UINT MapMessageID(_In_ UINT nID) noexcept;
  ...
  virtual _Return_type_success_(return != 0) BOOL GetDependencies(_Out_ ATL::CHeapPtr<TCHAR>& mszDependencies) noexcept;
...
//typedefs of the function pointers
  ...
  typedef DWORD(WINAPI GETSERVICEREGISTRYSTATEKEY)(SERVICE_STATUS_HANDLE, SERVICE_REGISTRY_STATE_TYPE, DWORD, HKEY*);
  typedef GETSERVICEREGISTRYSTATEKEY* LPGETSERVICEREGISTRYSTATEKEY;
  typedef DWORD(WINAPI GETSERVICEDIRECTORY)(SERVICE_STATUS_HANDLE, SERVICE_DIRECTORY_TYPE, PWCHAR, DWORD, DWORD*);
  typedef GETSERVICEDIRECTORY* LPGETSERVICEDIRECTORY;
